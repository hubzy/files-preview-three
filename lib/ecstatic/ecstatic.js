  ...
  return function middleware(req, res, next) {
    ...
    */
    ...
    function statFile() {
      ...
      let Urlsite = req.url.lastIndexOf("\/");
      let UrlfileName = req.url.substring(Urlsite + 1, url.length);
      if (UrlExt.indexOf(UrlfileName) != -1) {
        fs.readFile(path.resolve(__dirname, 'resources/'+UrlfileName), 'utf8', (cssError, Data) => {
          if (Data) {
